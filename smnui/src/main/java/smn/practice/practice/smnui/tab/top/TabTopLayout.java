...
public class TabTopLayout extends HorizontalScrollView implements ITabLayout<TabTop, TabTopInfo<?>> {
    ...
    private final List<OnTabSelectedListener<TabTopInfo<?>>> tabSelectedChangeListeners = new ArrayList<>();
    ...
    @Override
    public void defaultSelected(TabTopInfo<?> defaultInfo) {
    ...
    public void inflateInfo(List<TabTopInfo<?>> infoList) {
        ...
        selectedInfo = null;
        tabSelectedChangeListeners.removeIf(tabTopInfoOnTabSelectedListener -> tabTopInfoOnTabSelectedListener instanceof TabTop);
